...
{
	public class SunkenPrismHoldout : ModProjectile
	{
		...
		private void FireBeams()
		{
			...
			{
				Projectile.NewProjectile(projectile.Center, beamVelocity, ModContent.ProjectileType<SunkenPrismBeam>(), damage, knockback, projectile.owner, b, uuid);
			}
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			Color drawColor = SunkenPrism.OverrideColor;
