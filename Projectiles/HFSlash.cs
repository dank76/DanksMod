...
{
	public class HFSlash : ModProjectile
	{
		...
		{
            DisplayName.SetDefault("H.F Slash");
		}
		...
		public override void AI()
		{
			...
			{
				int redDust = Dust.NewDust(origin - projectile.Size / 2f, projectile.width, projectile.height, 217, projectile.velocity.X, projectile.velocity.Y, 100, default, 2f);
		...
		{
			return new global::Microsoft.Xna.Framework.Color?(new Color(0, 0, 200, 0));
		}
